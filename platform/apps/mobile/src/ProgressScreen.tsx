  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      <View style={s.header}>
        ...
        <Text style={s.headerSub}>Nível {lvl.number} · {lvl.name}</Text>
      </View>
          ...
          {pack.subjects.map((sub) => {
            ...
            return (
              <View key={sub.key} style={[s.subjRow, shadow]}>
                <View style={[s.subjIcon, { backgroundColor: sub.color }]}>
...
const s = StyleSheet.create({
  header: { backgroundColor: colors.primary, paddingHorizontal: space.lg, paddingTop: 60, paddingBottom: 24, borderBottomLeftRadius: radius.xl, borderBottomRightRadius: radius.xl },
  headerTitle: { color: colors.white, fontSize: 26, fontWeight: '900', letterSpacing: -0.5 },
  headerSub: { color: 'rgba(255,255,255,0.9)', fontSize: 14, fontWeight: '700', marginTop: 4 },
  statGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: space.md },
  statCard: { width: '47%', flexGrow: 1, backgroundColor: colors.card, borderRadius: radius.lg, padding: space.lg, gap: 6, borderWidth: 1, borderColor: colors.border },
  statIcon: { width: 42, height: 42, borderRadius: radius.md, alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
  ...
  subjRow: { flexDirection: 'row', alignItems: 'center', gap: space.md, backgroundColor: colors.card, borderRadius: radius.lg, padding: space.lg, borderWidth: 1, borderColor: colors.border },
  ...
  subjName: { fontSize: 16, fontWeight: '800', color: colors.text },
