...
const EXERCISES_11_Q_EXTRA = [
  ...
  { id:'11qe4', s:'quimica', t:'Equilíbrio químico — conceito e Kc', type:'mc', diff:3,
    q:'⚗️ Num reator de 2,0 dm³ atingiu-se o equilíbrio H₂(g) + I₂(g) ⇌ 2 HI(g) com 0,40 mol de H₂, 0,40 mol de I₂ e 2,40 mol de HI. Qual o valor de Kc?',
    opts:['36','12','144','9'],
    ans:0,
  ...
  { id:'11qe5', s:'quimica', t:'Equilíbrio químico — conceito e Kc', type:'mc', diff:3,
    q:'⚗️ Para uma reação em equilíbrio com Kc = 4,0 × 10⁻⁵, podemos concluir que:',
    opts:['o equilíbrio favorece os produtos','o equilíbrio favorece os reagentes','o equilíbrio é igualmente distribuído','a reação é instantânea'],
    ans:1,
  ...
  { id:'11qe6', s:'quimica', t:'Equilíbrio químico — conceito e Kc', type:'mc', diff:3,
    q:'⚗️ Se a reação direta tem Kc = 50, qual o valor de Kc para a reação INVERSA?',
    opts:['50','1/50 = 0,02','−50','2500'],
    ans:1,
    exp:'Kc(inverso) = 1 / Kc(direto) = 1/50 = 0,02.' },

  { id:'11qe7', s:'quimica', t:'Equilíbrio químico — conceito e Kc', type:'mc', diff:3,
    q:'⚗️ Para a reação 2 SO₂(g) + O₂(g) ⇌ 2 SO₃(g), Kc = 100 a determinada T. Se multiplicarmos a equação por 1/2 (SO₂ + ½ O₂ ⇌ SO₃), o novo Kc é:',
  ...
  // =====================================================
  { id:'11qe11', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:2,
    q:'⚗️ Num sistema com Qc < Kc, a reação evolui:',
    opts:['no sentido direto (forma mais produtos)','no sentido inverso (forma mais reagentes)','está em equilíbrio','não evolui'],
    ans:0,
    exp:'Qc < Kc → faltam produtos → reação avança no sentido direto até Qc = Kc.' },

  { id:'11qe12', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:2,
    q:'⚗️ Num sistema com Qc > Kc, a reação evolui:',
    opts:['no sentido direto','no sentido inverso','permanece igual','depende da temperatura'],
    ans:1,
    exp:'Qc > Kc → excesso de produtos → reação recua para regenerar reagentes.' },

  { id:'11qe13', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:3,
    q:'🔬 Para H₂(g) + I₂(g) ⇌ 2 HI(g) com Kc = 50. Mistura inicial: [H₂]=[I₂]=0,20 mol/dm³, [HI]=2,0 mol/dm³. Em que sentido evolui?',
    opts:['Sentido direto (forma HI)','Sentido inverso (forma H₂ e I₂)','Já está em equilíbrio','Sem dados suficientes'],
    ans:1,
    exp:'Qc = (2,0)² / (0,20·0,20) = 4/0,04 = 100. Como Qc(100) > Kc(50) → sentido inverso.',
    solution:'Calcula Qc=[HI]²/([H₂][I₂])=100. Compara com Kc=50: Qc>Kc → reação inversa.' },

  { id:'11qe14', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:2,
    q:'🌡️ Reação EXOTÉRMICA em equilíbrio. Aumenta-se a temperatura. O que acontece?',
    opts:['Equilíbrio desloca-se no sentido direto; Kc aumenta','Equilíbrio desloca-se no sentido inverso; Kc diminui','Não há alteração','Kc aumenta mas o equilíbrio não se desloca'],
    ans:1,
    exp:'Para exotérmica, calor é "produto". Aumentar T → contraria adicionando calor → desloca para reagentes; Kc diminui.' },

  { id:'11qe15', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:2,
    q:'🌡️ Reação ENDOTÉRMICA em equilíbrio. Baixar a temperatura faz com que:',
  ...
  { id:'11qe16', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:3,
  ...
  { id:'11qe17', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'tf', diff:2,
    q:'🧪 Adicionar um catalisador desloca o equilíbrio no sentido direto.',
    ans:false,
    exp:'O catalisador acelera AMBOS os sentidos por igual. NÃO desloca o equilíbrio nem altera Kc.' },

  { id:'11qe18', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:2,
  ...
  { id:'11qe19', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:3,
  ...
  { id:'11qe20', s:'quimica', t:'Quociente de reação e princípio de Le Châtelier', type:'mc', diff:2,
    ...
    ans:0,
    exp:'Remover reagente → contraria formando mais reagente → reação inversa.' },
  ...
  { id:'11qe43', s:'quimica', t:'Soluções tampão e titulações ácido-base', type:'mc', diff:3,
    ...
    ans:1,
    exp:'A reação produz apenas sal neutro + água → pH = 7.' },
  ...
  { id:'11qe62', s:'quimica', t:'Equilíbrio de oxidação-redução', type:'mc', diff:2,
    q:'⚡ Numa reação redox, o agente oxidante:',
  ...
  { id:'11qe63', s:'quimica', t:'Equilíbrio de oxidação-redução', type:'mc', diff:2,
    ...
    opts:['+1','−1','−2','0'],
    ans:2,
    exp:'O em compostos comuns tem n.o. = −2 (exceto peróxidos e OF₂).' },
  ...
  { id:'11qe66', s:'quimica', t:'Equilíbrio de oxidação-redução', type:'mc', diff:3,
    q:'⚡ Na reação Zn + 2 HCl → ZnCl₂ + H₂, qual é o agente OXIDANTE?',
  ...
  { id:'11qe68', s:'quimica', t:'Equilíbrio de oxidação-redução', type:'tf', diff:2,
    q:'⚡ Numa reação redox, o número total de electrões cedidos é igual ao número de electrões recebidos.',
    ans:true,
  ...
  // =====================================================
  { id:'11qe71', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:2,
  ...
  { id:'11qe72', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:2,
    q:'🔋 A função da PONTE SALINA numa pilha é:',
    opts:['Conduzir os electrões entre elétrodos','Manter a neutralidade elétrica das soluções','Aumentar a tensão da pilha','Catalisar a reação'],
    ans:1,
    exp:'A ponte salina permite migração de iões para evitar acumulação de carga em cada compartimento.' },

  { id:'11qe73', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:3,
  ...
  { id:'11qe74', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:3,
    q:'🔋 Numa pilha Zn/Cu, o elétrodo de zinco é o:',
  ...
  { id:'11qe75', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'tf', diff:2,
    q:'🔋 Uma pilha funciona espontaneamente se E°pilha > 0.',
    ans:true,
    exp:'E°pilha > 0 ↔ ΔG < 0 → reação espontânea.' },

  { id:'11qe76', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:3,
  ...
  { id:'11qe77', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:3,
  ...
  { id:'11qe78', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:3,
  ...
  { id:'11qe79', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'mc', diff:3,
  ...
  { id:'11qe80', s:'quimica', t:'Pilhas e potenciais de elétrodo', type:'order', diff:3,
